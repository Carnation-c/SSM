        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for(let i = 0; i < $cartList.length; i++) {
                    ...
                    var result=JSON.stringify($cartList[i].cartGoods);
                    var result2=eval("("+result+")");

                    let $col_name = $("<div>").addClass("col-name").text(result2.name);
                    var result=JSON.stringify($cartList[i].cartGoods);
                    var resultgoods=eval("("+result+")");
                    let $col_price=$("<div>").addClass("col-price").text(resultgoods.price);
